# ADR-0016 — moved to `mirador-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`mirador-service-shared/docs/adr/0016-external-secrets-operator.md`](https://gitlab.com/mirador1/mirador-service-shared/-/blob/main/docs/adr/0016-external-secrets-operator.md)
- **Local access via submodule** : `infra/shared/docs/adr/0016-external-secrets-operator.md`
- **Title** : External Secrets Operator + Google Secret Manager

This file is a stub kept solely to preserve cross-references in this
repo (any link to `docs/adr/0016-external-secrets-operator.md` from other files in
