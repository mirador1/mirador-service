# ADR-0021 — moved to `mirador-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`mirador-service-shared/docs/adr/0021-cost-deferred-industrial-patterns.md`](https://gitlab.com/mirador1/mirador-service-shared/-/blob/main/docs/adr/0021-cost-deferred-industrial-patterns.md)
- **Local access via submodule** : `infra/shared/docs/adr/0021-cost-deferred-industrial-patterns.md`
- **Title** : Cost-deferred industrial patterns

This file is a stub kept solely to preserve cross-references in this
repo (any link to `docs/adr/0021-cost-deferred-industrial-patterns.md` from other files in
