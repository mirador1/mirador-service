# ADR-0010 — moved to `mirador-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`mirador-service-shared/docs/adr/0010-otlp-push-to-collector.md`](https://gitlab.com/mirador1/mirador-service-shared/-/blob/main/docs/adr/0010-otlp-push-to-collector.md)
- **Local access via submodule** : `infra/shared/docs/adr/0010-otlp-push-to-collector.md`
- **Title** : OpenTelemetry OTLP push to a Collector (not Prometheus scrape)

This file is a stub kept solely to preserve cross-references in this
repo (any link to `docs/adr/0010-otlp-push-to-collector.md` from other files in
