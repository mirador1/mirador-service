# ADR-0036 — moved to `mirador-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`mirador-service-shared/docs/adr/0036-multi-cloud-terraform-posture.md`](https://gitlab.com/mirador1/mirador-service-shared/-/blob/main/docs/adr/0036-multi-cloud-terraform-posture.md)
- **Local access via submodule** : `infra/shared/docs/adr/0036-multi-cloud-terraform-posture.md`
- **Title** : Multi-cloud Terraform posture

This file is a stub kept solely to preserve cross-references in this
repo (any link to `docs/adr/0036-multi-cloud-terraform-posture.md` from other files in
