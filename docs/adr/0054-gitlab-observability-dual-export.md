# ADR-0054 — moved to `mirador-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`mirador-service-shared/docs/adr/0054-gitlab-observability-dual-export.md`](https://gitlab.com/mirador1/mirador-service-shared/-/blob/main/docs/adr/0054-gitlab-observability-dual-export.md)
- **Local access via submodule** : `infra/shared/docs/adr/0054-gitlab-observability-dual-export.md`
- **Title** : Dual-export OTLP telemetry to GitLab Observability

This file is a stub kept solely to preserve cross-references in this
repo (any link to `docs/adr/0054-gitlab-observability-dual-export.md` from other files in
