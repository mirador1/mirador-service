...
**Triggered by** : `MiradorEnrichmentSuccessSLO` page or ticket alert.
...
| `KafkaTimeoutException` on producer side | Broker unreachable | Check broker pod, network policy |
